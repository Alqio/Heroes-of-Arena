...
dmg = max(0, (attacker.weapon.damage + scr_gladiator_attack_bonuses(attacker, "damage")) - 
             (attackee.defense + scr_gladiator_attack_bonuses(attackee, "defense")))
...
if (attackee.hp <= 0) {
    ...
    dmg = max(0, (attackee.weapon.damage + scr_gladiator_attack_bonuses(attackee, "damage")) - 
             (attacker.defense + scr_gladiator_attack_bonuses(attacker, "defense")))
