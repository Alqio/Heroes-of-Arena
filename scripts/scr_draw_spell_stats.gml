...
draw_shadow("Damage: (" + string(spell.damage) + " * spell level) + (" + string(spell.spell_power_damage) + " * spell power)", xx, yy + 24, color)
draw_shadow("Mana cost: " + string(spell.mana_cost), xx, yy + 36, color)
